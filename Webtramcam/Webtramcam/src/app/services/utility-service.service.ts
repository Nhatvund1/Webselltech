...
export class UtilityServiceService {
  ...
  deletecartitems(productId: number) {
    return this.navigationService.deleteCartItem(productId);
    
  }
  getalllproduct(){
    return this.navigationService.getallProduct();
  }
  ...
  deleteproductad(productId: number){
    return this.navigationService.deleteProduct(productId);
  }
}
